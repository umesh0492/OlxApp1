...
public class SearchBoxWithBg extends RelativeLayout {
	 ...
	 */
	public SearchBoxWithBg(Context context) {
		this(context, null);
	}
	 ...
	 */
	public SearchBoxWithBg(Context context, AttributeSet attrs) {
	 ...
	 */
	public SearchBoxWithBg(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		inflate(context, R.layout.searchbox_withbg, this);
...
/*	public void setLogoText(String text) {
	...
	private void revealFrom(float x, float y, Activity a, SearchBoxWithBg s) {
