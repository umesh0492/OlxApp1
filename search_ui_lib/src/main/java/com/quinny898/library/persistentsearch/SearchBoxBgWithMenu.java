...
public class SearchBoxBgWithMenu extends RelativeLayout {
	 ...
	 */
	public SearchBoxBgWithMenu(Context context) {
		this(context, null);
	}
	 ...
	 */
	public SearchBoxBgWithMenu(Context context, AttributeSet attrs) {
	 ...
	 */
	public SearchBoxBgWithMenu(Context context, AttributeSet attrs, int defStyle) {
